...
public class SupHomeTC {
	
	WebElement element;
	WebDriver driver;
	WebDriverWait wait;
	String ext = Url.sup_home;
...
// GLOBAL HEADER ***************************************************************
	...
	@Test()
	  public void home_prescr_inf_header() throws IOException {
		driver.get(Url.url1+Url.sup_home);
	...
	@Test
	public void home_imbr_logo() {
		Global_header.home_imbr_logo(driver, ext).click();
...
// ***********  FOOTER *************************************************************************	
	@Test()
	  public void home_prescr_inf_upper() throws IOException {
		driver.get(Url.url1+Url.sup_home);
		String parent_window = driver.getWindowHandle();
	...
	@Test
	public void home_privacy_upper(){
		driver.get(Url.url1+Url.sup_home);
		String parent_window = driver.getWindowHandle();
	...
	@Test
	public void home_pharmacyclics_logo(){
		driver.get(Url.url1+Url.sup_home);
		String parent_window = driver.getWindowHandle();
	...
	@Test()
	  public void home_prescr_inf_footer() throws IOException {
		driver.get(Url.url1+Url.sup_home);
		String parent_window = driver.getWindowHandle();
	...
	@Test
	public void home_privacy_footer(){
		driver.get(Url.url1+Url.sup_home);
		String parent_window = driver.getWindowHandle();
	...
	@Test
	public void home_legal_footer(){
		Global_footer.legal_footer(driver, ext).click();
		wait.until(ExpectedConditions.urlMatches(Url.url1 + Url.cll_legal));
		wait.until(ExpectedConditions.titleIs(Titles.cll_legal));
		}
	@Test
	public void home_contact_us(){
...
//******************************************************************************************************		
	...
	@Test
	  public void home_isi_prescr_inf_upper() throws IOException {
		  driver.get(Url.url1+Url.sup_home);
		if( driver.findElement(Global_isi.toggle).isDisplayed()){
	...
	@Test
	public void home_isi_legal_upper(){
		    driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
	...
	@Test
	public void home_isi_privacy_upper(){
		  driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
		String parent_window = driver.getWindowHandle();
	...
	@Test
	public void home_isi_pharmacyclics_logo(){
		  driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
		String parent_window = driver.getWindowHandle();
	...
	@Test
	public void home_isi_janssen_logo(){
		  driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
		String parent_window = driver.getWindowHandle();
	...
	@Test
	  public void home_isi_prescr_inf_footer() throws IOException {
		  driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
		String parent_window = driver.getWindowHandle();
	...
	@Test
	public void home_isi_unsubscribe() {
		  driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
	...
	@Test
	public void home_isi_privacy_footer(){
		  driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
		String parent_window = driver.getWindowHandle();
	...
	@Test
	public void home_isi_legal_footer(){
		  driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
	...
	@Test
	public void home_isi_contact_us(){
		  driver.get(Url.url1+Url.sup_home);
			if( driver.findElement(Global_isi.toggle).isDisplayed()){
	...
	public void TEST (){
		...
		//Global_footer.just(driver, Url.cll_home, wait);
	...
	public void home_isi(){
	 ...
	 public  void just(){
			...
			driver.get(Url.url1+Url.cll_home);
			
			//element = driver.findElement(toggle);
				if( driver.findElement(Global_footer.toggle).isDisplayed()){
					System.out.println("Hello");
				}} 
	 
	 @Test
	 public void pdf_handler() throws IOException {
		 element = Global_header.prescr_inf (driver, ext);
		 
		 Temp_test.home_prescr_inf_header(driver, ext, wait, element);
